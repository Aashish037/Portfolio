...
export function AboutPreview() {
  ...
  const tabContent = {
    journey:
      "My journey in software development started with a fascination for creating things that live on the internet. As a beginner developer, I'm constantly learning and growing, taking on new challenges with enthusiasm.",
    passion:
      "I'm passionate about learning and building digital experiences that make a difference. Whether it's a simple website or a mobile app, I love the process of turning ideas into working code.",
    approach:
      "I believe in learning by doing and taking one step at a time. Every project starts with understanding the basics, then gradually adding more features.",
  };
      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-6">
          <div className="relative">
            <h2 className="text-3xl lg:text-5xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 bg-clip-text text-transparent animate-pulse">
              About Me
            </h2>
